...
function getTodayBookingsCount() {
    $.ajax({
        url: BASE_URL + "/CarRent/countTodayBookings/" + today,
        method: "GET",
        success: function (res) {
            if (res.data != 0) {
                if (res.data < 10) {
...
function getAvailableDriverCount() {
    ...
    $.ajax({
        url: BASE_URL + "/driver/count/" + availability,
        method: "GET",
        success: function (res) {
            if (res.data != 0) {
                if (res.data < 10) {
...
function loadTodayBookings() {
    ...
    $.ajax({
        url: BASE_URL + "/CarRent/getTodayBookings/" + today,
        method: "GET",
        success: function (res) {
...
function uploadCarImages(registrationID) {
    ...
    $.ajax({
        url: BASE_URL + "/car/up/" + registrationID,
        method: "PUT",
        async: true,
        contentType: false,
        processData: false,
...
function deleteCar() {
    ...
    $.ajax({
        url: BASE_URL + "/car?registrationNo=" + registrationNo,
        method: "DELETE",
        success: function (res) {
            loadAllCars();
            swal({
...
function searchCar() {
    ...
    $.ajax({
        url: BASE_URL + "/car/" + registrationNo,
        method: "GET",
        success: function (res) {
            let car = res.data;
            $('#carTable').empty();
...
function acceptCustomer(id) {
    $.ajax({
        url: BASE_URL + "/customer/updateStatus/" + id,
        method: "PUT",
        success: function (res) {
...
function loadRegisteredCustomers() {
    ...
    $.ajax({
        url: BASE_URL + "/customer/accepted",
        method: "GET",
        success: function (res) {
            for (const customer of res.data) {
...
function searchCustomer() {
    ...
    $.ajax({
        url: BASE_URL + "/customer/register/" + id,
        method: "GET",
        success: function (res) {
...
function loadAvailableDrivers() {
    ...
    $.ajax({
        url: BASE_URL + "/driver/getAllAvailableDrivers",
        method: "GET",
        success: function (res) {
...
function loadNonAvailableDrivers() {
    ...
    $.ajax({
        url: BASE_URL + "/driver/getAllNonAvailableDrivers",
        method: "GET",
        success: function (res) {
            for (const driver of res.data) {
                let row = `<tr><td>${driver.licenceNo}</td><td>${driver.name}</td><td>${driver.address}</td><td>${driver.contactNo}</td><td>${driver.nicNo}</td><td>${driver.availability}</td></tr>`;
...
function deleteDriver() {
    ...
    $.ajax({
        url: BASE_URL + "/driver?licenceNo=" + licenceNo,
        method: "DELETE",
        success: function (res) {
            loadAvailableDrivers();
            loadNonAvailableDrivers();
...
function loadAllAcceptedRentals() {
    ...
    $.ajax({
        url: BASE_URL + "/CarRent/get/" + status,
        method: "GET",
        success: function (res) {
            for (const carRent of res.data) {
                let licence;
...
function searchPaymentByDate() {
    ...
    $('#tblPayments').empty();
    $.ajax({
        url: BASE_URL + "/payment/" + fromDate + "/" + toDate,
        method: "GET",
        success: function (res) {
            for (const payment of res.data) {
                let row = `<tr><td>${payment.paymentId}</td><td>${payment.date}</td><td>${payment.amount}</td><td>${payment.rental.rentId}</td><td>${payment.customer.customerId}</td></tr>`;
...
function acceptRental() {
    ...
    $.ajax({
        url: BASE_URL + "/CarRent/" + rentId + "/" + status,
        method: "PUT",
        success: function (res) {
            loadAllRentals();
            loadPendingRentals();
...
function updateCarStatus() {
    ...
    $.ajax({
        url: BASE_URL + "/car/updateCarStatus/" + registrationNO + "/" + status,
        method: "PUT",
        success: function (res) {
            loadAllCars();
            getAvailableCarCount();
...
function updateDriverStatus() {
    ...
    if (licenceNo != "No Driver") {
        $.ajax({
            url: BASE_URL + "/driver/updateNonAvailable/" + licenceNo,
            method: "PUT",
            success: function (res) {
                loadAvailableDrivers();
                loadNonAvailableDrivers();
...
function rejectRentals(rentId) {
    $.ajax({
        url: BASE_URL + "/CarRent?rentId=" + rentId,
        method: "DELETE",
        success: function (res) {
            loadAllRentals();
            loadPendingRentals();
...
function generateMaintenanceId() {
    $.ajax({
        url: BASE_URL + "/maintenance/generateMaintenanceId",
        method: "GET",
        success: function (res) {
...
function loadAllUnderMaintenanceCars() {
    ...
    $.ajax({
        url: BASE_URL + "/car/getByStatus/" + status,
        method: "GET",
        success: function (res) {
...
function generatePaymentID() {
    $.ajax({
        url: BASE_URL + "/payment/generatePaymentId",
        method: "GET",
        success: function (res) {
...
function generateReturnId() {
    $.ajax({
        url: BASE_URL + "/carRentReturn/generateReturnId",
        method: "GET",
        success: function (res) {
...
function calculateTotalPaidPayments(carRent) {
    $.ajax({
        url: BASE_URL + "/payment/calculatePaidPayment/" + carRent.rentId,
        method: "GET",
        success: function (res) {
...
function updateDStatus(licenceNo) {
    ...
    $.ajax({
        url: BASE_URL + "/driver/updateAvailable/" + licenceNo,
        method: "PUT",
        success: function (res) {
            getAvailableDriverCount();
            getOccupiedDriverCount();
...
function searchMaintenances(fromDate, toDate) {
    ...
    $.ajax({
        url:BASE_URL + "/maintenance/getAll/" + fromDate + "/" + toDate,
        method:"GET",
        success:function (res) {
            let cost = 0.0;
            for (let maintenance of res.data) {
