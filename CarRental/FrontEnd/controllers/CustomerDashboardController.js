...
function getAllUserData(username, password) {
    $.ajax({
        url: "http://localhost:8081/BackEnd_war/customer/set/" + username + "/" + password,
        method: "GET",
        success: function (res) {
...
function loadMyAllPayments(customerId) {
    $('#paymentsTable').empty();
    $.ajax({
        url: "http://localhost:8081/BackEnd_war/payment/getAll/" + customerId,
        method: "GET",
        success: function (res) {
...
function loadMyCarRentsToTable(customerId) {
    ...
    $.ajax({
        url: "http://localhost:8081/BackEnd_war/CarRent/getMyCarRents/" + customerId,
        method: "GET",
        success: function (res) {
...
function generateRentId() {
    $.ajax({
        url: "http://localhost:8081/BackEnd_war/CarRent/generateRentId",
        method: "GET",
        success: function (res) {
...
function generatePaymentId() {
    $.ajax({
        url: "http://localhost:8081/BackEnd_war/payment/generatePaymentId",
        method: "GET",
        success: function (res) {
...
function deletePayment(rentId, licenceNo, registrationNo, customerId) {
    $.ajax({
        url: baseUrl + "/payment/delete/" + rentId,
        method: "DELETE",
        success: function (res) {
            console.log("Deleted Payment");
            let status = "Available";
...
function updateDriverStatusByLicenceNo(licenceNo) {
    $.ajax({
        url: baseUrl + "/driver/updateAvailable/" + licenceNo,
        method: "PUT",
        success: function (res) {
